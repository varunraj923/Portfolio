  ...
  return (
    <div className='flex flex-col items-center mt-60'>
      ...
      <div className='flex flex-col items-center justify-center mt-32 md:flex-row md:space-x-12'>
        <div className='w-full max-w-lg p-6 mb-8 bg-white rounded-lg shadow-lg md:mb-0'>
          <h1 className='text-xl font-bold text-center'>Cineverse AI - OTT Platform wih AI</h1>
          <div className='flex justify-center mt-6 space-x-4 text-3xl text-black'>
            <SiReact />
            <SiRedux />
            <SiTailwindcss />
          ...
          <p className='mt-6 text-center text-gray-500'>
            A modern OTT platform powered by React, Redux, and Firebase Authentication. Features include personalized recommendations, secure user sessions, and AI-driven content tagging for smarter discovery.
          </p>
          <a
            className='block px-4 py-2 mt-6 text-center text-blue-800 transition-colors duration-300 border-2 border-blue-700 rounded-lg hover:bg-blue-700 hover:text-white'
            href="https://github.com/varunraj923/cinetalks"
            target="_blank"
            rel="noopener noreferrer"
          >
            Check it Out!
        ...
        <div className='w-full max-w-lg mt-8 md:mt-0'>
          <img className='rounded-lg' src={cineverse} alt="Netflix-GPT Screenshot" />
        </div>
      </div>
    </div>
  );
